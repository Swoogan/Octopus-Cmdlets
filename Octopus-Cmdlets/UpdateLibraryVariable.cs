...
namespace Octopus_Cmdlets
{
    ...
    ///   </para>
    /// </example>
    [Cmdlet(VerbsData.Update, "LibraryVariable")]
    public class UpdateLibraryVariable : PSCmdlet
    {
        /// <summary>
        ...
        /// </summary>
         [Parameter(
            ...
            HelpMessage = "The Library VariableSet containing the variable to update.")]
        ...
        protected override void BeginProcessing()
        {
            ...
            // Find the variable set that owns the variables we want to edit
            ...
            WriteDebug("Found variable set" + libraryVariableSet.Id);
